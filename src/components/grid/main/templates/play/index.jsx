...
import setEvents, { start } from './script/backgroundImageTable'
      ...
      <Main title='Jogo' subtitle='Aproveite o jogo'>
        <div className='content-play'>
          <div className='tittle-content'>
            <span className='legend-content'>Run</span>
          ...
          <Modal visible={this.state.runner} width='1000' height='600' effect='fadeInUp' onClickAway={this.closeModal}>
            <Runner participants={this.state.participants} data={data} closeModal={this.closeModal} />
          </Modal>
        </div>
      </Main>
    )
